...
#define ZEPHIR_CONCAT_SSSVSSVSS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_sssvssvss(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, sizeof(op9)-1, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_SSSVSSVSS(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_sssvssvss(&result, op1, sizeof(op1)-1, op2, sizeof(op2)-1, op3, sizeof(op3)-1, op4, op5, sizeof(op5)-1, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, sizeof(op9)-1, 1 TSRMLS_CC);
